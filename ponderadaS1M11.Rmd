...
Com o calculo do interquartil não foi encontrado nenhum outlier.
...
ggplot(dados, aes(x = quantidade, y = preco)) +
...
Na analise bivariada usando da matriz de correlação e do grafico de dispersão podemos perceber mais sobre a correlação preco/quantidade, no grafico de dispersão parece termos uma correlação grande entre essas variaveis, mas ao ver a matriz de correlação percebemos que a correlação entre essas variaveis é de 0.38 o que não é algo tão alto.
